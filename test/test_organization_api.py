...
class TestOrganizationApi(unittest.TestCase):
    ...
    def test_delete_org_runner(self) -> None:
    ...
    def test_get_org_runner(self) -> None:
    ...
    def test_get_org_runners(self) -> None:
    ...
    def test_get_org_workflow_jobs(self) -> None:
        """Test case for get_org_workflow_jobs

        Get org-level workflow jobs
        """
        pass

    def test_get_org_workflow_runs(self) -> None:
        """Test case for get_org_workflow_runs
    ...
    def test_org_create_runner_registration_token(self) -> None:
    ...
    def test_org_delete_repos(self) -> None:
        """Test case for org_delete_repos
    ...
    def test_update_org_runner(self) -> None:
        """Test case for update_org_runner
