    ...
    def make_instance(self, include_optional) -> PullRequest:
        ...
        if include_optional:
            return PullRequest(
                ...
                base = py_gitea_opensuse_org.models.pr_branch_info.PRBranchInfo(
                    label = '', 
                    ref = '', 
                ...
                head = py_gitea_opensuse_org.models.pr_branch_info.PRBranchInfo(
                    label = '', 
                    ref = '', 
                    repo = py_gitea_opensuse_org.models.repository.Repository(
                        allow_fast_forward_only_merge = True, 
                ...
                merged_by = py_gitea_opensuse_org.models.user.User(
                    active = True, 
                    avatar_url = '', 
                    created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    description = '', 
