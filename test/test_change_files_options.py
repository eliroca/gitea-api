    ...
    def make_instance(self, include_optional) -> ChangeFilesOptions:
        ...
        if include_optional:
            return ChangeFilesOptions(
                author = gitea_api.models.identity.Identity(
                    email = '', 
                    name = '', ),
                branch = '',
                committer = gitea_api.models.identity.Identity(
                    email = '', 
                    name = '', ),
                dates = gitea_api.models.commit_date_options.CommitDateOptions(
                ...
                files = [
                    gitea_api.models.change_file_operation.ChangeFileOperation(
                        content = '', 
                        from_path = '', 
                        operation = 'create', 
                        path = '', 
