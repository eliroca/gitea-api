...
class Issue(BaseModel):
    ...
    content_version: Optional[StrictInt] = Field(default=None, description="The version of the issue content for optimistic locking")
    ...
    time_estimate: Optional[StrictInt] = None
    title: Optional[StrictStr] = None
    updated_at: Optional[datetime] = None
    url: Optional[StrictStr] = None
    user: Optional[User] = None
    __properties: ClassVar[List[str]] = ["assets", "assignee", "assignees", "body", "closed_at", "comments", "content_version", "created_at", "due_date", "html_url", "id", "is_locked", "labels", "milestone", "number", "original_author", "original_author_id", "pin_order", "projects", "pull_request", "ref", "repository", "state", "time_estimate", "title", "updated_at", "url", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "time_estimate": obj.get("time_estimate"),
            "title": obj.get("title"),
