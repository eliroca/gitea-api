...
class RepoCollaboratorPermission(BaseModel):
    ...
    """ # noqa: E501
    permission: Optional[StrictStr] = Field(default=None, description="Permission level of the collaborator none AccessLevelNameNone read AccessLevelNameRead write AccessLevelNameWrite admin AccessLevelNameAdmin owner AccessLevelNameOwner")
    role_name: Optional[StrictStr] = Field(default=None, description="RoleName is the name of the permission role")
