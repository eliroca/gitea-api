...
class User(BaseModel):
    ...
    login: Optional[StrictStr] = Field(default=None, description="login of the user, same as `username`")
    ...
    visibility: Optional[StrictStr] = Field(default=None, description="User visibility level option: public, limited, private public UserVisibilityPublic limited UserVisibilityLimited private UserVisibilityPrivate")
