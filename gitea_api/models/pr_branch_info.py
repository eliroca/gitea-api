...
class PRBranchInfo(BaseModel):
    ...
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="The display name of the branch")
    ref: Optional[StrictStr] = Field(default=None, description="The git reference of the branch")
    repo: Optional[Repository] = None
    repo_id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the repository")
    sha: Optional[StrictStr] = Field(default=None, description="The commit SHA of the branch head")
