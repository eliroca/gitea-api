...
class CreateHookOption(BaseModel):
    ...
    events: Optional[List[StrictStr]] = Field(default=None, description="List of events that will trigger this webhook")
    name: Optional[StrictStr] = Field(default=None, description="Optional human-readable name for the webhook")
    type: StrictStr
    __properties: ClassVar[List[str]] = ["active", "authorization_header", "branch_filter", "config", "events", "name", "type"]
