...
class NodeInfoUsage(BaseModel):
    ...
    """ # noqa: E501
    local_comments: Optional[StrictInt] = Field(default=None, description="LocalComments is the total amount of comments made by users local to this server", alias="localComments")
    local_posts: Optional[StrictInt] = Field(default=None, description="LocalPosts is the total amount of posts made by users local to this server", alias="localPosts")
