...
class CreateRepoOption(BaseModel):
    ...
    object_format_name: Optional[StrictStr] = Field(default=None, description="ObjectFormatName of the underlying git repository, empty string for default (sha1) sha1 ObjectFormatSHA1 sha256 ObjectFormatSHA256")
