...
class EditIssueOption(BaseModel):
    ...
    content_version: Optional[StrictInt] = Field(default=None, description="The current version of the issue content to detect conflicts during editing")
    due_date: Optional[datetime] = None
    milestone: Optional[StrictInt] = None
    projects: Optional[List[StrictInt]] = Field(default=None, description="list of project ids to set (replaces existing projects)")
    ref: Optional[StrictStr] = None
    state: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    unset_due_date: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["assignee", "assignees", "body", "content_version", "due_date", "milestone", "projects", "ref", "state", "title", "unset_due_date"]
