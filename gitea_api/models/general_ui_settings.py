...
class GeneralUISettings(BaseModel):
    ...
    """ # noqa: E501
    allowed_reactions: Optional[List[StrictStr]] = Field(default=None, description="AllowedReactions contains the list of allowed emoji reactions")
    custom_emojis: Optional[List[StrictStr]] = Field(default=None, description="CustomEmojis contains the list of custom emojis")
    default_theme: Optional[StrictStr] = Field(default=None, description="DefaultTheme is the default UI theme")
