...
class ActionWorkflowJobsResponse(BaseModel):
    """
    ActionWorkflowJobsResponse returns ActionWorkflowJobs
    """ # noqa: E501
    jobs: Optional[List[ActionWorkflowJob]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": [ActionWorkflowJob.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None,
