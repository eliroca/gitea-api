...
class TimelineComment(BaseModel):
    ...
    body: Optional[StrictStr] = Field(default=None, description="Body contains the timeline event content")
    ...
    id: Optional[StrictInt] = Field(default=None, description="ID is the unique identifier for the timeline comment")
    ...
    type: Optional[StrictStr] = Field(default=None, description="Type indicates the type of timeline event")
