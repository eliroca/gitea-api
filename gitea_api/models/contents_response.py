...
class ContentsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_links", "content", "download_url", "encoding", "git_url", "html_url", "last_author_date", "last_commit_sha", "last_committer_date", "name", "path", "sha", "size", "submodule_git_url", "target", "type", "url"]
