...
class NodeInfoServices(BaseModel):
    ...
    """ # noqa: E501
    inbound: Optional[List[StrictStr]] = Field(default=None, description="Inbound lists services that can deliver content to this server")
    outbound: Optional[List[StrictStr]] = Field(default=None, description="Outbound lists services this server can deliver content to")
