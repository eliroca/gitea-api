...
class PullReview(BaseModel):
    ...
    html_url: Optional[StrictStr] = Field(default=None, description="HTMLURL is the web URL for viewing the review")
    id: Optional[StrictInt] = None
    official: Optional[StrictBool] = None
    pull_request_url: Optional[StrictStr] = Field(default=None, description="HTMLPullURL is the web URL for the pull request")
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['APPROVED', 'PENDING', 'COMMENT', 'REQUEST_CHANGES', 'REQUEST_REVIEW']):
            raise ValueError("must be one of enum values ('APPROVED', 'PENDING', 'COMMENT', 'REQUEST_CHANGES', 'REQUEST_REVIEW')")
        return value
