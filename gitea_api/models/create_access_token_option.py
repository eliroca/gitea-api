...
class CreateAccessTokenOption(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    scopes: Optional[List[StrictStr]] = Field(default=None, json_schema_extra={"examples": [["all", "read:activitypub", "read:issue", "write:misc", "read:notification", "read:organization", "read:package", "read:repository", "read:user"]]})
