...
class BranchProtection(BaseModel):
    ...
    block_admin_merge_override: Optional[StrictBool] = None
    ...
    bypass_allowlist_teams: Optional[List[StrictStr]] = None
    bypass_allowlist_usernames: Optional[List[StrictStr]] = None
    created_at: Optional[datetime] = None
    dismiss_stale_approvals: Optional[StrictBool] = None
    enable_approvals_whitelist: Optional[StrictBool] = None
    enable_bypass_allowlist: Optional[StrictBool] = None
    enable_force_push: Optional[StrictBool] = None
    enable_force_push_allowlist: Optional[StrictBool] = None
    ...
    force_push_allowlist_deploy_keys: Optional[StrictBool] = None
    force_push_allowlist_teams: Optional[List[StrictStr]] = None
    force_push_allowlist_usernames: Optional[List[StrictStr]] = None
    ...
    priority: Optional[StrictInt] = Field(default=None, description="Priority is the priority of this branch protection rule")
    ...
    rule_name: Optional[StrictStr] = Field(default=None, description="RuleName is the name of the branch protection rule")
    status_check_contexts: Optional[List[StrictStr]] = None
    unprotected_file_patterns: Optional[StrictStr] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["approvals_whitelist_teams", "approvals_whitelist_username", "block_admin_merge_override", "block_on_official_review_requests", "block_on_outdated_branch", "block_on_rejected_reviews", "branch_name", "bypass_allowlist_teams", "bypass_allowlist_usernames", "created_at", "dismiss_stale_approvals", "enable_approvals_whitelist", "enable_bypass_allowlist", "enable_force_push", "enable_force_push_allowlist", "enable_merge_whitelist", "enable_push", "enable_push_whitelist", "enable_status_check", "force_push_allowlist_deploy_keys", "force_push_allowlist_teams", "force_push_allowlist_usernames", "ignore_stale_approvals", "merge_whitelist_teams", "merge_whitelist_usernames", "priority", "protected_file_patterns", "push_whitelist_deploy_keys", "push_whitelist_teams", "push_whitelist_usernames", "require_signed_commits", "required_approvals", "rule_name", "status_check_contexts", "unprotected_file_patterns", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "block_admin_merge_override": obj.get("block_admin_merge_override"),
            ...
            "bypass_allowlist_teams": obj.get("bypass_allowlist_teams"),
            "bypass_allowlist_usernames": obj.get("bypass_allowlist_usernames"),
            ...
            "enable_bypass_allowlist": obj.get("enable_bypass_allowlist"),
            "enable_force_push": obj.get("enable_force_push"),
            "enable_force_push_allowlist": obj.get("enable_force_push_allowlist"),
            ...
            "force_push_allowlist_deploy_keys": obj.get("force_push_allowlist_deploy_keys"),
            "force_push_allowlist_teams": obj.get("force_push_allowlist_teams"),
            "force_push_allowlist_usernames": obj.get("force_push_allowlist_usernames"),
