...
class Activity(BaseModel):
    ...
    act_user_id: Optional[StrictInt] = Field(default=None, description="The ID of the user who performed the action")
    comment: Optional[Comment] = None
    comment_id: Optional[StrictInt] = Field(default=None, description="The ID of the comment associated with the activity (if applicable)")
    content: Optional[StrictStr] = Field(default=None, description="Additional content or details about the activity")
    created: Optional[datetime] = Field(default=None, description="The date and time when the activity occurred")
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the activity")
    is_private: Optional[StrictBool] = Field(default=None, description="Whether this activity is from a private repository")
    op_type: Optional[StrictStr] = Field(default=None, description="the type of action")
    ref_name: Optional[StrictStr] = Field(default=None, description="The name of the git reference (branch/tag) associated with the activity")
    repo: Optional[Repository] = None
    repo_id: Optional[StrictInt] = Field(default=None, description="The ID of the repository associated with the activity")
    user_id: Optional[StrictInt] = Field(default=None, description="The ID of the user who receives/sees this activity")
