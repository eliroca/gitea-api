...
class GitignoreTemplateInfo(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name is the name of the gitignore template")
    source: Optional[StrictStr] = Field(default=None, description="Source contains the content of the gitignore template")
