...
class EditRepoOption(BaseModel):
    ...
    allow_merge_update: Optional[StrictBool] = Field(default=None, description="either `true` to allow updating pull request branch by merge, or `false` to prevent it.")
    ...
    default_update_style: Optional[StrictStr] = Field(default=None, description="set to an update style to be used by this repository: \"merge\" or \"rebase\".")
    ...
    has_code: Optional[StrictBool] = Field(default=None, description="either `true` to enable code for this repository or `false` to disable it.")
    ...
    mirror_password: Optional[StrictStr] = Field(default=None, description="authentication password for the remote repository (mirrors)")
    mirror_token: Optional[StrictStr] = Field(default=None, description="authentication token for the remote repository (mirrors)")
    mirror_username: Optional[StrictStr] = Field(default=None, description="authentication username for the remote repository (mirrors)")
    ...
    __properties: ClassVar[List[str]] = ["allow_fast_forward_only_merge", "allow_manual_merge", "allow_merge_commits", "allow_merge_update", "allow_rebase", "allow_rebase_explicit", "allow_rebase_update", "allow_squash_merge", "archived", "autodetect_manual_merge", "default_allow_maintainer_edit", "default_branch", "default_delete_branch_after_merge", "default_merge_style", "default_update_style", "description", "enable_prune", "external_tracker", "external_wiki", "has_actions", "has_code", "has_issues", "has_packages", "has_projects", "has_pull_requests", "has_releases", "has_wiki", "ignore_whitespace_conflicts", "internal_tracker", "mirror_interval", "mirror_password", "mirror_token", "mirror_username", "name", "private", "projects_mode", "template", "website"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allow_merge_update": obj.get("allow_merge_update"),
            ...
            "mirror_password": obj.get("mirror_password"),
            "mirror_token": obj.get("mirror_token"),
            "mirror_username": obj.get("mirror_username"),
            "name": obj.get("name"),
