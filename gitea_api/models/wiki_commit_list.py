...
class WikiCommitList(BaseModel):
    ...
    """ # noqa: E501
    commits: Optional[List[WikiCommit]] = Field(default=None, description="The list of wiki commits")
    count: Optional[StrictInt] = Field(default=None, description="The total count of commits")
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.commits:
            for _item_commits in self.commits:
                _items.append(_item_commits.to_dict() if _item_commits is not None else None)
