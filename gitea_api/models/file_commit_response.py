...
class FileCommitResponse(BaseModel):
    ...
    html_url: Optional[StrictStr] = Field(default=None, description="HTMLURL is the web URL for viewing this commit")
    message: Optional[StrictStr] = Field(default=None, description="Message is the commit message")
    parents: Optional[List[CommitMeta]] = Field(default=None, description="Parents contains parent commit metadata")
