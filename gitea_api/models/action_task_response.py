...
class ActionTaskResponse(BaseModel):
    ...
    """ # noqa: E501
    total_count: Optional[StrictInt] = Field(default=None, description="TotalCount is the total number of workflow runs")
    workflow_runs: Optional[List[ActionTask]] = Field(default=None, description="Entries contains the list of workflow runs")
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.workflow_runs:
            for _item_workflow_runs in self.workflow_runs:
                _items.append(_item_workflow_runs.to_dict() if _item_workflow_runs is not None else None)
