...
class TrackedTime(BaseModel):
    ...
    id: Optional[StrictInt] = Field(default=None, description="ID is the unique identifier for the tracked time entry")
    ...
    user_name: Optional[StrictStr] = Field(default=None, description="username of the user")
