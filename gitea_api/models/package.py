...
class Package(BaseModel):
    ...
    html_url: Optional[StrictStr] = Field(default=None, description="The HTML URL to view the package")
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the package")
    name: Optional[StrictStr] = Field(default=None, description="The name of the package")
    owner: Optional[User] = None
    repository: Optional[Repository] = None
    type: Optional[StrictStr] = Field(default=None, description="The type of the package (e.g., npm, maven, docker)")
