...
class ActionRunner(BaseModel):
    ...
    labels: Optional[List[ActionRunnerLabel]] = None
    name: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["busy", "ephemeral", "id", "labels", "name", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "labels": [ActionRunnerLabel.from_dict(_item) for _item in obj["labels"]] if obj.get("labels") is not None else None,
            "name": obj.get("name"),
