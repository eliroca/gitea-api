...
class Repository(BaseModel):
    ...
    allow_manual_merge: Optional[StrictBool] = None
    allow_merge_commits: Optional[StrictBool] = None
    allow_merge_update: Optional[StrictBool] = None
    ...
    autodetect_manual_merge: Optional[StrictBool] = None
    ...
    default_target_branch: Optional[StrictStr] = None
    ...
    has_code: Optional[StrictBool] = None
    ...
    mirror_last_sync_at: Optional[datetime] = None
    mirror_updated: Optional[datetime] = None
    name: Optional[StrictStr] = None
    object_format_name: Optional[StrictStr] = Field(default=None, description="ObjectFormatName of the underlying git repository sha1 ObjectFormatSHA1 sha256 ObjectFormatSHA256")
    ...
    __properties: ClassVar[List[str]] = ["allow_fast_forward_only_merge", "allow_manual_merge", "allow_merge_commits", "allow_merge_update", "allow_rebase", "allow_rebase_explicit", "allow_rebase_update", "allow_squash_merge", "archived", "archived_at", "autodetect_manual_merge", "avatar_url", "branch_count", "clone_url", "created_at", "default_allow_maintainer_edit", "default_branch", "default_delete_branch_after_merge", "default_merge_style", "default_target_branch", "default_update_style", "description", "empty", "external_tracker", "external_wiki", "fork", "forks_count", "full_name", "has_actions", "has_code", "has_issues", "has_packages", "has_projects", "has_pull_requests", "has_releases", "has_wiki", "html_url", "id", "ignore_whitespace_conflicts", "internal", "internal_tracker", "language", "languages_url", "licenses", "link", "mirror", "mirror_interval", "mirror_last_sync_at", "mirror_updated", "name", "object_format_name", "open_issues_count", "open_pr_counter", "original_url", "owner", "parent", "permissions", "private", "projects_mode", "release_counter", "repo_transfer", "size", "ssh_url", "stars_count", "template", "topics", "updated_at", "url", "watchers_count", "website"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "default_target_branch": obj.get("default_target_branch"),
            ...
            "mirror_last_sync_at": obj.get("mirror_last_sync_at"),
