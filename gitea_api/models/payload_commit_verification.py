...
class PayloadCommitVerification(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[StrictStr] = Field(default=None, description="The signed payload content")
    reason: Optional[StrictStr] = Field(default=None, description="The reason for the verification status")
    signature: Optional[StrictStr] = Field(default=None, description="The GPG signature of the commit")
    signer: Optional[PayloadUser] = None
    verified: Optional[StrictBool] = Field(default=None, description="Whether the commit signature is verified")
