...
class AddCollaboratorOption(BaseModel):
    ...
    """ # noqa: E501
    permission: Optional[StrictStr] = Field(default=None, description="Permission level to grant the collaborator read RepoWritePermissionRead write RepoWritePermissionWrite admin RepoWritePermissionAdmin")
