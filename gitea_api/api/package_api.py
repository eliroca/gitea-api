...
class PackageApi:
    ...
    def _delete_package_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/packages/{owner}/{type}/{name}',
    ...
    def delete_package_version(
        ...
        _param = self._delete_package_version_serialize(
            owner=owner,
            type=type,
            name=name,
            version=version,
    ...
    @validate_call
    def delete_package_version_with_http_info(
        self,
        owner: Annotated[StrictStr, Field(description="owner of the package")],
        type: Annotated[StrictStr, Field(description="type of the package")],
        name: Annotated[StrictStr, Field(description="name of the package")],
    ...
    @validate_call
    def delete_package_version_without_preload_content(
        self,
        owner: Annotated[StrictStr, Field(description="owner of the package")],
        type: Annotated[StrictStr, Field(description="type of the package")],
        name: Annotated[StrictStr, Field(description="name of the package")],
    ...
    def _delete_package_version_serialize(
        self,
        owner,
        type,
        name,
    ...
    def get_latest_package_version(
        ...
        _param = self._get_latest_package_version_serialize(
            owner=owner,
            type=type,
            name=name,
            _request_auth=_request_auth,
    ...
    def _get_latest_package_version_serialize(
        self,
        owner,
        type,
        name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/packages/{owner}/{type}/{name}/-/latest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_package_versions(
        ...
        _param = self._list_package_versions_serialize(
            owner=owner,
            type=type,
            name=name,
            page=page,
    ...
    def _list_package_versions_serialize(
        self,
        owner,
        type,
        name,
