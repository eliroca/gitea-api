...
------------- | ------------- | -------------
[**delete_current_token**](MiscellaneousApi.md#delete_current_token) | **DELETE** /token | Delete the currently authenticated token
[**get_current_token**](MiscellaneousApi.md#get_current_token) | **GET** /token | Get the currently authenticated token
...
[**get_signing_key_ssh**](MiscellaneousApi.md#get_signing_key_ssh) | **GET** /signing-key.pub | Get default signing-key.pub
...
with gitea_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete the currently authenticated token
        api_instance.delete_current_token()
    except Exception as e:
        print("Exception when calling MiscellaneousApi->delete_current_token: %s\n" % e)
```
...
# **get_current_token**
> CurrentAccessToken get_current_token()
...
with gitea_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MiscellaneousApi->get_current_token:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MiscellaneousApi->get_current_token: %s\n" % e)
```
...
with gitea_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get default signing-key.pub
        api_response = api_instance.get_signing_key_ssh()
        print("The response of MiscellaneousApi->get_signing_key_ssh:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MiscellaneousApi->get_signing_key_ssh: %s\n" % e)
```
