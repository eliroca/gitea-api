...
**priority** | **int** | Priority is the priority of this branch protection rule | [optional] 
...
**rule_name** | **str** | RuleName is the name of the branch protection rule | [optional] 
