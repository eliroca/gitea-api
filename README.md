...
```sh
pip install git+https://github.com/eliroca/gitea-api.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/eliroca/gitea-api.git`)
...
*AdminApi* | [**admin_create_runner_registration_token**](docs/AdminApi.md#admin_create_runner_registration_token) | **POST** /admin/actions/runners/registration-token | Get a global actions runner registration token
...
*AdminApi* | [**delete_admin_runner**](docs/AdminApi.md#delete_admin_runner) | **DELETE** /admin/actions/runners/{runner_id} | Delete a global runner
*AdminApi* | [**get_admin_runner**](docs/AdminApi.md#get_admin_runner) | **GET** /admin/actions/runners/{runner_id} | Get a global runner
...
*AdminApi* | [**update_admin_runner**](docs/AdminApi.md#update_admin_runner) | **PATCH** /admin/actions/runners/{runner_id} | Update a global runner
*IssueApi* | [**issue_add_assignees**](docs/IssueApi.md#issue_add_assignees) | **POST** /repos/{owner}/{repo}/issues/{index}/assignees | Add assignees to an issue
...
*IssueApi* | [**issue_check_assignee**](docs/IssueApi.md#issue_check_assignee) | **GET** /repos/{owner}/{repo}/issues/{index}/assignees/{assignee} | Check if a user can be assigned to an issue
...
*IssueApi* | [**issue_remove_assignees**](docs/IssueApi.md#issue_remove_assignees) | **DELETE** /repos/{owner}/{repo}/issues/{index}/assignees | Remove assignees from an issue
...
*MiscellaneousApi* | [**delete_current_token**](docs/MiscellaneousApi.md#delete_current_token) | **DELETE** /token | Delete the currently authenticated token
*MiscellaneousApi* | [**get_current_token**](docs/MiscellaneousApi.md#get_current_token) | **GET** /token | Get the currently authenticated token
...
*OrganizationApi* | [**org_delete_repos**](docs/OrganizationApi.md#org_delete_repos) | **DELETE** /orgs/{org}/repos | Delete all repositories in an organization
...
*OrganizationApi* | [**update_org_runner**](docs/OrganizationApi.md#update_org_runner) | **PATCH** /orgs/{org}/actions/runners/{runner_id} | Update an org-level runner
...
*PackageApi* | [**delete_package**](docs/PackageApi.md#delete_package) | **DELETE** /packages/{owner}/{type}/{name} | Delete a package
*PackageApi* | [**delete_package_version**](docs/PackageApi.md#delete_package_version) | **DELETE** /packages/{owner}/{type}/{name}/{version} | Delete a package version
...
*RepositoryApi* | [**accept_repo_reparent**](docs/RepositoryApi.md#accept_repo_reparent) | **POST** /repos/{owner}/{repo}/reparent/accept | Accept a reparenting request
...
*RepositoryApi* | [**actions_list_workflow_runs**](docs/RepositoryApi.md#actions_list_workflow_runs) | **GET** /repos/{owner}/{repo}/actions/workflows/{workflow_id}/runs | List runs for a workflow
...
*RepositoryApi* | [**delete_repo_runner**](docs/RepositoryApi.md#delete_repo_runner) | **DELETE** /repos/{owner}/{repo}/actions/runners/{runner_id} | Delete a repo-level runner
...
*RepositoryApi* | [**get_repo_runner**](docs/RepositoryApi.md#get_repo_runner) | **GET** /repos/{owner}/{repo}/actions/runners/{runner_id} | Get a repo-level runner
...
*RepositoryApi* | [**get_workflow_run_attempt**](docs/RepositoryApi.md#get_workflow_run_attempt) | **GET** /repos/{owner}/{repo}/actions/runs/{run}/attempts/{attempt} | Gets a specific workflow run attempt
...
*RepositoryApi* | [**list_workflow_run_attempt_jobs**](docs/RepositoryApi.md#list_workflow_run_attempt_jobs) | **GET** /repos/{owner}/{repo}/actions/runs/{run}/attempts/{attempt}/jobs | Lists all jobs for a workflow run attempt
...
*RepositoryApi* | [**reject_repo_reparent**](docs/RepositoryApi.md#reject_repo_reparent) | **POST** /repos/{owner}/{repo}/reparent/reject | Reject a reparenting request
...
*RepositoryApi* | [**repo_check_assignee**](docs/RepositoryApi.md#repo_check_assignee) | **GET** /repos/{owner}/{repo}/assignees/{assignee} | Check if a user can be assigned to issues in a repository
...
*RepositoryApi* | [**repo_create_pull_review**](docs/RepositoryApi.md#repo_create_pull_review) | **POST** /repos/{owner}/{repo}/pulls/{index}/reviews | Create a review to a pull request
*RepositoryApi* | [**repo_create_pull_review_comment_reply**](docs/RepositoryApi.md#repo_create_pull_review_comment_reply) | **POST** /repos/{owner}/{repo}/pulls/{index}/comments/{id}/replies | Reply to a pull request review comment
...
*RepositoryApi* | [**repo_reparent**](docs/RepositoryApi.md#repo_reparent) | **POST** /repos/{owner}/{repo}/reparent | Reparent a repo
*RepositoryApi* | [**repo_resolve_pull_review_comment**](docs/RepositoryApi.md#repo_resolve_pull_review_comment) | **POST** /repos/{owner}/{repo}/pulls/comments/{id}/resolve | Resolve a pull request review comment
...
*RepositoryApi* | [**repo_submit_pull_review**](docs/RepositoryApi.md#repo_submit_pull_review) | **POST** /repos/{owner}/{repo}/pulls/{index}/reviews/{id} | Submit a pending review to a pull request
...
*RepositoryApi* | [**repo_unresolve_pull_review_comment**](docs/RepositoryApi.md#repo_unresolve_pull_review_comment) | **POST** /repos/{owner}/{repo}/pulls/comments/{id}/unresolve | Unresolve a pull request review comment
*RepositoryApi* | [**repo_update_avatar**](docs/RepositoryApi.md#repo_update_avatar) | **POST** /repos/{owner}/{repo}/avatar | Update avatar
*RepositoryApi* | [**repo_update_branch**](docs/RepositoryApi.md#repo_update_branch) | **PUT** /repos/{owner}/{repo}/branches/{branch} | Update a branch reference to a new commit
...
*RepositoryApi* | [**repo_update_file**](docs/RepositoryApi.md#repo_update_file) | **PUT** /repos/{owner}/{repo}/contents/{filepath} | Update a file in a repository if SHA is set, or create the file if SHA is not set
...
*RepositoryApi* | [**rerun_failed_workflow_run**](docs/RepositoryApi.md#rerun_failed_workflow_run) | **POST** /repos/{owner}/{repo}/actions/runs/{run}/rerun-failed-jobs | Reruns all failed jobs in a workflow run
*RepositoryApi* | [**rerun_workflow_job**](docs/RepositoryApi.md#rerun_workflow_job) | **POST** /repos/{owner}/{repo}/actions/runs/{run}/jobs/{job_id}/rerun | Reruns a specific workflow job in a run
*RepositoryApi* | [**rerun_workflow_run**](docs/RepositoryApi.md#rerun_workflow_run) | **POST** /repos/{owner}/{repo}/actions/runs/{run}/rerun | Reruns an entire workflow run
*RepositoryApi* | [**topic_search**](docs/RepositoryApi.md#topic_search) | **GET** /topics/search | search topics via keyword
*RepositoryApi* | [**update_repo_runner**](docs/RepositoryApi.md#update_repo_runner) | **PATCH** /repos/{owner}/{repo}/actions/runners/{runner_id} | Update a repo-level runner
...
*UserApi* | [**delete_user_runner**](docs/UserApi.md#delete_user_runner) | **DELETE** /user/actions/runners/{runner_id} | Delete a user-level runner
...
*UserApi* | [**get_user_runner**](docs/UserApi.md#get_user_runner) | **GET** /user/actions/runners/{runner_id} | Get a user-level runner
...
*UserApi* | [**update_user_runner**](docs/UserApi.md#update_user_runner) | **PATCH** /user/actions/runners/{runner_id} | Update a user-level runner
...
*UserApi* | [**user_create_runner_registration_token**](docs/UserApi.md#user_create_runner_registration_token) | **POST** /user/actions/runners/registration-token | Get a user&#39;s actions runner registration token
...
## Documentation For Models
 ...
 - [CreatePullReviewCommentReplyOptions](docs/CreatePullReviewCommentReplyOptions.md)
 ...
 - [Cron](docs/Cron.md)
 - [CurrentAccessToken](docs/CurrentAccessToken.md)
 ...
 - [EditActionRunnerOption](docs/EditActionRunnerOption.md)
 ...
 - [Issue](docs/Issue.md)
 - [IssueAssigneesOption](docs/IssueAssigneesOption.md)
 ...
 - [ReparentRepoOption](docs/ReparentRepoOption.md)
